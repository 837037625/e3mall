...
<!-- /rest/page/item-edit -->
<div id="itemEditWindow" class="easyui-window" title="编辑商品" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/item/editPage'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
        ...
        handler:function(){
        	...
        	$("#itemEditWindow").window({
        		onLoad :function(){
        			...
        			// 加载商品描述
        			$.getJSON('/item/getItemDesc?id='+data.id,function(_data){
        				if(_data.status == 200){
